...
class SDK {
  ...
  constructor() {
    ...
    this.core = new APICore(this.spec, 'pixup/2 (api/6.1.3)');
  }
...
export type { CreateQrcodeBodyParam, CreateQrcodeResponse200, CreateQrcodeResponse401, FazerUmPagamentoBodyParam, FazerUmPagamentoResponse200, FazerUmPagamentoResponse400 } from './types';
